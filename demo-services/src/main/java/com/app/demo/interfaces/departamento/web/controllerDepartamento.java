 ...
 */
package com.app.demo.interfaces.departamento.web;

import com.app.demo.interfaces.departamento.facade.DepartamentoFacade;
...
@Api(value = "Departamento microservice", description = "This API has a CRUD for Departamento")
