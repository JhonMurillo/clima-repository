 ...
 */
package com.app.demo.interfaces.ciudad.web;

import com.app.demo.interfaces.ciudad.dto.CiudadDTO;
import com.app.demo.interfaces.ciudad.facade.CiudadFacade;
...
@Api(value = "Ciudad microservice", description = "This API has a CRUD for Ciudad")
...
public class controllerCiudad {
    ...
    @ApiOperation(value = "findAll", notes = "Return a CiudadDTO")
