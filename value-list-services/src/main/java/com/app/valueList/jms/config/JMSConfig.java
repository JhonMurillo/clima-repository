package com.app.valueList.jms.config;
...
public class JMSConfig {
    ...
    @Value("${messages.queue.jmsvaluelist}")
    private String topicJmsValueList;
    ...
    @Bean
    public ActiveMQTopic topicJmsValueList() {
        return new ActiveMQTopic(topicJmsValueList);
    }
}
